...
/*
	...
	public function formular_benutzerdaten_lesen() {
        ...
        $this->iban                     = c3po::verschluesseln($_POST["iban"]);
        $this->bic                      = c3po::verschluesseln($_POST["bic"]);
        $this->monate[1]                = $_POST["monat1"];
        $this->monate[2]                = $_POST["monat2"];
        $this->monate[3]                = $_POST["monat3"];
        $this->monate[4]                = $_POST["monat4"];
        $this->monate[5]                = $_POST["monat5"];
        $this->monate[6]                = $_POST["monat6"];
        $this->monate[7]                = $_POST["monat7"];
        $this->monate[8]                = $_POST["monat8"];
        $this->monate[9]                = $_POST["monat9"];
        $this->monate[10]               = $_POST["monat10"];
        $this->monate[11]               = $_POST["monat11"];
        $this->monate[12]               = $_POST["monat11"];
        $this->jahresbeitrag            = $_POST["jahresbeitrag"];
        $this->monatsbeitrag            = $_POST["monatsbeitrag"];
	...
	private function daten_bearbeiten() {
        ...
        `iban`          = '".$this->iban."',              
        `bis`           = '".$this->bic."',                  
        `monate1`       = '".$this->monate[1]."',               
        `monate2`       = '".$this->monate[2]."',            
        `monate3`       = '".$this->monate[3]."',              
        `monate4`       = '".$this->monate[4]."',        
        `monate5`       = '".$this->monate[5]."',            
        `monate6`       = '".$this->monate[6]."',        
        `monate7`       = '".$this->monate[7]."',        
        `monate8`       = '".$this->monate[8]."',      
        `monate9`       = '".$this->monate[9]."',
        `monate10`      = '".$this->monate[10]."',         
        `monate11`      = '".$this->monate[11]."',         
        `monate12`      = '".$this->monate[12]."',           
